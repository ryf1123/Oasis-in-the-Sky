// function Drawable() {
	...
	Cow.prototype.move = function(duration, axisPos){
	  var _this = this;
	  this.status = "walking";
	...
	Rabbit.prototype.move = function(duration, axisPos){
	  // Movement
	...
	Wolf.prototype.move = function(duration, axisPos){
