var Rabbits = function(){
	...
	Rabbit.prototype.retreat = function(){
		var _this = this;
		side = -5;
	...
	Rabbit.prototype.interrupt = function(){
        ...
        TweenMax.to(this.earL.rotation, 0.5, {x: 0, y: 0, z: 0, ease:Power4.easeInOut});
        TweenMax.to(this.earR.rotation, 0.5, {x: 0, y: 0, z: 0, ease:Power4.easeInOut});
        TweenMax.to(this.pawBL.rotation, 0.5, {x: 0, y: 0, z: 0, ease:Power4.easeInOut});
        TweenMax.to(this.pawBR.rotation, 0.5, {x: 0, y: 0, z: 0, ease:Power4.easeInOut});
        TweenMax.to(this.pawFL.rotation, 0.5, {x: 0, y: 0, z: 0, ease:Power4.easeInOut});
        TweenMax.to(this.pawFR.rotation, 0.5, {x: 0, y: 0, z: 0, ease:Power4.easeInOut});
        TweenMax.to(this.eyeL.scale, 0.5, {x: 1, y: 1, z: 1, ease:Power4.easeInOut});

        TweenMax.to(this.head.position, 0.5, {x: 0, y: 11, z: 2, ease:Power4.easeInOut});
        TweenMax.to(this.earL.rotation, 0.5, {x: 0.28631756738680253, y: 0, z: -0.2617993877991494, ease:Power4.easeInOut});
        TweenMax.to(this.torso.position, 0.5, {x: 0, y: 7, z: 0, ease:Power4.easeInOut});
        TweenMax.to(this.pawFR.position, 0.5, {x: -2, y: 1.5, z: 6, ease:Power4.easeInOut});
        TweenMax.to(this.pawFL.position, 0.5, {x: 2, y: 1.5, z: 6, ease:Power4.easeInOut});
        TweenMax.to(this.pawBR.position, 0.5, {x: -5, y: 1.5, z: 0, ease:Power4.easeInOut});
        TweenMax.to(this.pawBL.position, 0.5, {x: 5, y: 1.5, z: 0, ease:Power4.easeInOut});
	...
	for (var i = rabbitsInfo.length - 1; i >= 0; i--) {
    	...
    	this.rabbits[i].buffer = new myAnti_Jitter(defaultActionTime + ( Math.random() - 0.5 ) * defaultActionTime);
    	this.rabbits[i].buffer.clear();
