...
var myAABB = (function () {
    ...
    myAABB.prototype.update = function ( new_boxloc) {
    ...
    myAABB.prototype.disable = function()
    {
        this.enabled = false;
    };

    myAABB.prototype.enable = function () {
        this.enabled = true;
    };

    myAABB.prototype.detect = function ( box ) {
    ...
    myAABB.prototype.collisionOver = function () {
        this.iscollision = false;
    };
